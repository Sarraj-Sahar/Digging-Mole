...
// 1.  variables
  int numberOfSquares = 4 * 4;
  int numberInEachRow = 4;
...
//3. bomb locations : specify where bombs are located
  final List<int> bombLocation = [3, 10];
        ...
        child: Container(
          decoration: const BoxDecoration(
            image: DecorationImage(
              image: AssetImage("lib/assets/light_bg.png"),
              fit: BoxFit.cover,
            ),
          ),
          child: Column(
...
//// New SecondScreenBody
  Widget _SecondScreenBody() {
    return Expanded(
